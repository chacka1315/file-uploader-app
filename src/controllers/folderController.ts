...
const folder_create_get: RequestHandler = (req, res) => {
...
const folder_create_post: RequestHandler = async (req, res, next) => {
...
const folder_view_get: RequestHandler = async (req, res, next) => {
  let { id } = req.params;
  let folderId: number;
  if (typeof id !== 'string') {
...
const folder_update_get: RequestHandler = async (req, res, next) => {
  let { id } = req.params;
  let folderId: number;
  if (typeof id !== 'string') {
    folderId = Number(id[0]);
...
const folder_update_post: RequestHandler = async (req, res, next) => {
  let { id } = req.params;
  let folderId: number;
  if (typeof id !== 'string') {
    folderId = Number(id[0]);
...
const folder_delete_post: RequestHandler = async (req, res, next) => {
  let { id } = req.params;
  let folderId: number;
  if (typeof id !== 'string') {
    folderId = Number(id[0]);
